...
$getreportCSGOSellAccountID = $_GET['reportCSGOSellAccountID'];
...
AND b.CSGO_SELLACCOUNTID = $getreportCSGOSellAccountID 
";

$result = mysqli_query($conn,$sql);
$row = mysqli_fetch_assoc($result);

$csgosellAccountID = ['CSGO_SELLACCOUNTID'];
$userID1 = $row['Name'];

if(isset($_POST['report'])){
    $reportcsgosellaccountCategory = mysqli_real_escape_string($conn,$_POST['reportcsgosellaccountCategory']);
    $reportcsgosellaccountDetails = mysqli_real_escape_string($conn,$_POST['reportcsgosellaccountDetails']);
    $sql = "INSERT INTO `reportuser` (USER_ID,CSGO_SELLACCOUNTID,
    REPORT_CATEGORY,REPORT_DETAIL)
    VALUES((SELECT USER_ID FROM users WHERE USER_USERNAME='$useruserName'),
    (SELECT CSGO_SELLACCOUNTID FROM csgosellaccount WHERE CSGO_SELLACCOUNTID='$getreportCSGOSellAccountID'),
    '$reportcsgosellaccountCategory','$reportcsgosellaccountDetails')";
    $result=mysqli_query($conn,$sql);
    if($result){
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class = "form">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" aria-label="Default select example" name="reportcsgosellaccountCategory">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" name="reportcsgosellaccountDetails" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" autocomplete="off" required></textarea>
                        ...
                        <div class="inputfield">
                            <button type="button" class="btn btn-primary btn-lg btn-block" 
                                onclick="location.href = 'csgoaccountforsale.php'">
                                Back
                            </button>
                        </div>
