  ...
  if (empty($firstName) || empty($middleName) || empty($lastName) || empty($dateofBirth) || empty($emailAddress) || empty($phoneNumber) || 
    ...
    //if the username is already exists
      ...
      if($results){
        ...
        $messageFail = "Unsuccessful create Account please try again";
      ...
      <form method = "post" action="" >
        ...
        <div class="form">
          ...
          <div class="inputfield">
            ...
            <input type="text" class="input" placeholder="Enter user username" name="username" autocomplete="off" value="<?php if (isset($_POST['submit'])) { echo $username; } ?>">
            <?php echo $messageIcon; ?>
          </div> 
          ...
          <div class="inputfield">
            ...
            <input type="password" class="input" id="password" placeholder="Enter user password" name="password" autocomplete="off" required value="<?php if (isset($_POST['submit'])) { echo $password; } ?>">
          </div>
