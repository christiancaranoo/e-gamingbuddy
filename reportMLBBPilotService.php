...
$getreportMLBBPilotServiceID = $_GET['reportMLBBPilotServiceID'];
...
AND b.ML_PILOTSERVICEID = $getreportMLBBPilotServiceID  
";

$result = mysqli_query($conn,$sql);
$row = mysqli_fetch_assoc($result);

$mlpilotserviceID = ['ML_PILOTSERVICEID'];
$userID = $row['Name'];

if(isset($_POST['report'])){
    $reportmlbbpilotserviceCategory = mysqli_real_escape_string($conn,$_POST['reportmlbbpilotserviceCategory']);
    $reportmlbbpilotserviceDetails = mysqli_real_escape_string($conn,$_POST['reportmlbbpilotserviceDetails']);
    $sql = "INSERT INTO `reportuser` (USER_ID,ML_PILOTSERVICEID,
    REPORT_CATEGORY,REPORT_DETAIL)
    VALUES((SELECT USER_ID FROM users WHERE USER_USERNAME='$useruserName'),
    (SELECT ML_PILOTSERVICEID FROM mlpilotservice WHERE ML_PILOTSERVICEID='$getreportMLBBPilotServiceID'),
    '$reportmlbbpilotserviceCategory','$reportmlbbpilotserviceDetails')";
    $result=mysqli_query($conn,$sql);
    if($result){
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class = "form">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" aria-label="Default select example" name="reportmlbbpilotserviceCategory">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" name="reportmlbbpilotserviceDetails" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" autocomplete="off" required></textarea>
                        ...
                        <div class="inputfield">
                            <button type="button" class="btn btn-primary btn-lg btn-block" 
                                onclick="location.href = 'mlbbpilotservice.php'">
                                Back
                            </button>
                        </div>
