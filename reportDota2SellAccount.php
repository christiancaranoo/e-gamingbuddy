...
$getreportDota2SellAccountID = $_GET['reportDota2SellAccountID'];
...
AND b.DOTA2_SELLACCOUNTID = $getreportDota2SellAccountID 
";

$result = mysqli_query($conn,$sql);
$row = mysqli_fetch_assoc($result);

$dota2sellAccountID = ['DOTA2_SELLACCOUNTID'];
$userID1 = $row['Name'];

if(isset($_POST['report'])){
    $reportdota2sellaccountCategory = mysqli_real_escape_string($conn,$_POST['reportdota2sellaccountCategory']);
    $reportdota2sellaccountDetails = mysqli_real_escape_string($conn,$_POST['reportdota2sellaccountDetails']);
    $sql = "INSERT INTO `reportuser` (USER_ID,DOTA2_SELLACCOUNTID,
    REPORT_CATEGORY,REPORT_DETAIL)
    VALUES((SELECT USER_ID FROM users WHERE USER_USERNAME='$useruserName'),
    (SELECT DOTA2_SELLACCOUNTID FROM dota2sellaccount WHERE DOTA2_SELLACCOUNTID='$getreportDota2SellAccountID '),
    '$reportdota2sellaccountCategory','$reportdota2sellaccountDetails')";
    $result=mysqli_query($conn,$sql);
    if($result){
                    ...
                    <div class = "form">
                        ...
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label"><b>User ID:</b> <?php echo $userID2;?>
                                &emsp;<b>Name:</b> <?php echo $userID1;?>
                            </label>
                            <br>
                            <label for="recipient-name" class="col-form-label"><b>Category:</b></label>
                            <select class="form-select" aria-label="Default select example" name="reportdota2sellaccountCategory">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" name="reportdota2sellaccountDetails" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" autocomplete="off" required></textarea>
                        ...
                        <div class="inputfield">
                            <button type="button" class="btn btn-primary btn-lg btn-block" 
                                onclick="location.href = 'dota2accountforsale.php'">
                                Back
                            </button>
                        </div>
