...
$getreportCSGOSellItemID = $_GET['reportCSGOSellItemID'];
...
AND b.CSGO_SELLITEMID = $getreportCSGOSellItemID
";

$result = mysqli_query($conn,$sql);
$row = mysqli_fetch_assoc($result);

$csgosellitemID = ['CSGO_SELLITEMID'];
$userID = $row['Name'];

if(isset($_POST['report'])){
    $reportcsgosellitemCategory = mysqli_real_escape_string($conn,$_POST['reportcsgosellitemCategory']);
    $reportcsgosellitemDetails = mysqli_real_escape_string($conn,$_POST['reportcsgosellitemDetails']);
    $sql = "INSERT INTO `reportuser` (USER_ID,CSGO_SELLITEMID,
    REPORT_CATEGORY,REPORT_DETAIL)
    VALUES((SELECT USER_ID FROM users WHERE USER_USERNAME='$useruserName'),
    (SELECT CSGO_SELLITEMID FROM csgosellitem WHERE CSGO_SELLITEMID='$getreportCSGOSellItemID'),
    '$reportcsgosellitemCategory','$reportcsgosellitemDetails')";
    $result=mysqli_query($conn,$sql);
    if($result){
...
$csgosellitemIDID2 = ['CSGO_SELLITEMID'];
$userID2 = $row['USER_ID'];
?>
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class = "form">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" aria-label="Default select example" name="reportcsgosellitemCategory">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" name="reportcsgosellitemDetails" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" autocomplete="off" required></textarea>
                        ...
                        <div class="inputfield">
                            <button type="button" class="btn btn-primary btn-lg btn-block" 
                                onclick="location.href = 'csgoitemforsale.php'">
                                Back
                            </button>
                        </div>
