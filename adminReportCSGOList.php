...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8">
        <title>Admin - CSGO Report List</title>
            ...
            <div class="table-responsive-xxl">
                ...
                <nav aria-label="...">
                    <ul class="pagination pagination-lg">
                        ...
                        <li class="page-item active" aria-current="page"><a class="page-link" href="#"><img src="image/csgoicon.jpg" height = "35" width = "35"> CSGO</a></li>
