...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8">
        <title>Admin - Valorant Report</title>
            ...
            <div class="table-responsive-xxl">
                ...
                <nav aria-label="...">
                    <ul class="pagination pagination-lg">
                        ...
                        <li class="page-item active" aria-current="page"><a class="page-link" href="#"><img src = "image/valorantlogo.png" width="35" height="35" alt = "Valorant"> Valorant</a></li>
