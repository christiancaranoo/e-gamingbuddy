...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8">
        <title>Admin - Mobile Legends Report List</title>
            ...
            <div class="table-responsive-xxl">
                ...
                <nav aria-label="...">
                    <ul class="pagination pagination-lg">
                        ...
                        <li class="page-item active" aria-current="page"><a class="page-link" href="#"><img src = "image/mobilelegends.jpg" width="35" height="35" alt = "Mobile Legends" > Mobile Legends</a></li>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <?php
                            ...
                            WHERE
                            b.USER_ID=U.USER_ID
                            AND DOTA2_SELLITEMID IS NULL
                            AND DOTA2_SELLACCOUNTID IS NULL
                            AND DOTA2_PSID IS NULL
