...
$getreportCOCSellAccountID = $_GET['reportCOCSellAccountID'];
...
AND b.CLASHOFCLAN_ID = $getreportCOCSellAccountID 
";

$result = mysqli_query($conn,$sql);
$row = mysqli_fetch_assoc($result);

$cocsellAccountID = ['CLASHOFCLAN_ID'];
$userID1 = $row['Name'];

if(isset($_POST['report'])){
    $reportcocsellaccountCategory = mysqli_real_escape_string($conn,$_POST['reportcocsellaccountCategory']);
    $reportcocsellaccountDetails = mysqli_real_escape_string($conn,$_POST['reportcocsellaccountDetails']);
    $sql = "INSERT INTO `reportuser` (USER_ID,CLASHOFCLAN_ID,
    REPORT_CATEGORY,REPORT_DETAIL)
    VALUES((SELECT USER_ID FROM users WHERE USER_USERNAME='$useruserName'),
    (SELECT CLASHOFCLAN_ID FROM clashofclansellaccount WHERE CLASHOFCLAN_ID='$getreportCOCSellAccountID'),
    '$reportcocsellaccountCategory','$reportcocsellaccountDetails')";
    $result=mysqli_query($conn,$sql);
    if($result){
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class = "form">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" aria-label="Default select example" name="reportcocsellaccountCategory">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" name="reportcocsellaccountDetails" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" autocomplete="off" required></textarea>
                        ...
                        <div class="inputfield">
                            <button type="button" class="btn btn-primary btn-lg btn-block" 
                                onclick="location.href = 'clashofclanaccountforsale.php'">
                                Back
                            </button>
                        </div>
