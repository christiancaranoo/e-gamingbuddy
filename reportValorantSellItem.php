...
$getreportValorantSellItemID = $_GET['reportValorantSellItemID'];
...
AND b.VALORANT_SELLITEMID = $getreportValorantSellItemID
";

$result = mysqli_query($conn,$sql);
$row = mysqli_fetch_assoc($result);

$valorantsellitemID = ['VALORANT_SELLITEMID'];
$userID = $row['Name'];

if(isset($_POST['report'])){
    $reportvalorantsellitemCategory = mysqli_real_escape_string($conn,$_POST['reportvalorantsellitemCategory']);
    $reportvalorantsellitemDetails = mysqli_real_escape_string($conn,$_POST['reportvalorantsellitemDetails']);
    $sql = "INSERT INTO `reportuser` (USER_ID,VALORANT_SELLITEMID,
    REPORT_CATEGORY,REPORT_DETAIL)
    VALUES((SELECT USER_ID FROM users WHERE USER_USERNAME='$useruserName'),
    (SELECT VALORANT_SELLITEMID FROM valorantsellitem WHERE VALORANT_SELLITEMID='$getreportValorantSellItemID'),
    '$reportvalorantsellitemCategory','$reportvalorantsellitemDetails')";
    $result=mysqli_query($conn,$sql);
    if($result){
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class = "form">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" aria-label="Default select example" name="reportvalorantsellitemCategory">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" name="reportvalorantsellitemDetails" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" autocomplete="off" required></textarea>
                        ...
                        <div class="inputfield">
                            <button type="button" class="btn btn-primary btn-lg btn-block" 
                                onclick="location.href = 'valorantitemforsale.php'">
                                Back
                            </button>
                        </div>
