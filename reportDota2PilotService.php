...
$getreportDota2PilotServiceID = $_GET['reportDota2PilotServiceID'];
...
AND b.DOTA2_PSID = $getreportDota2PilotServiceID  
";

$result = mysqli_query($conn,$sql);
$row = mysqli_fetch_assoc($result);

$dota2pilotserviceID = ['DOTA2_PSID'];
$userID = $row['Name'];

if(isset($_POST['report'])){
    $reportdota2pilotserviceCategory = mysqli_real_escape_string($conn,$_POST['reportdota2pilotserviceCategory']);
    $reportdota2pilotserviceDetails = mysqli_real_escape_string($conn,$_POST['reportdota2pilotserviceDetails']);
    $sql = "INSERT INTO `reportuser` (USER_ID,DOTA2_PSID,
    REPORT_CATEGORY,REPORT_DETAIL)
    VALUES((SELECT USER_ID FROM users WHERE USER_USERNAME='$useruserName'),
    (SELECT DOTA2_PSID FROM dota2pilotservice WHERE DOTA2_PSID='$getreportDota2PilotServiceID'),
    '$reportdota2pilotserviceCategory','$reportdota2pilotserviceDetails')";
    $result=mysqli_query($conn,$sql);
    if($result){
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class = "form">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" aria-label="Default select example" name="reportdota2pilotserviceCategory">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" name="reportdota2pilotserviceDetails" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" autocomplete="off" required></textarea>
                        ...
                        <div class="inputfield">
                            <button type="button" class="btn btn-primary btn-lg btn-block" 
                                onclick="location.href = 'dota2pilotservice.php'">
                                Back
                            </button>
                        </div>
