...
$getreportDota2SellItemID = $_GET['reportDota2SellItemID'];
...
AND b.DOTA2_SELLITEMID = $getreportDota2SellItemID 
";

$result = mysqli_query($conn,$sql);
$row = mysqli_fetch_assoc($result);

$dota2sellitemID = ['DOTA2_SELLITEMID'];
$userID = $row['Name'];

if(isset($_POST['report'])){
    $reportdota2sellitemCategory = mysqli_real_escape_string($conn,$_POST['reportdota2sellitemCategory']);
    $reportdota2sellitemDetails = mysqli_real_escape_string($conn,$_POST['reportdota2sellitemDetails']);
    $sql = "INSERT INTO `reportuser` (USER_ID,DOTA2_SELLITEMID,
    REPORT_CATEGORY,REPORT_DETAIL)
    VALUES((SELECT USER_ID FROM users WHERE USER_USERNAME='$useruserName'),
    (SELECT DOTA2_SELLITEMID FROM dota2sellitem WHERE DOTA2_SELLITEMID='$getreportDota2SellItemID'),
    '$reportdota2sellitemCategory','$reportdota2sellitemDetails')";
    $result=mysqli_query($conn,$sql);
    if($result){
...
$dota2sellitemID2 = ['DOTA2_SELLITEMID'];
$userID2 = $row['USER_ID'];
?>
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class = "form">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" aria-label="Default select example" name="reportdota2sellitemCategory">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" name="reportdota2sellitemDetails" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" autocomplete="off" required></textarea>
