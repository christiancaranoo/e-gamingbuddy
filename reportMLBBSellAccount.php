...
$getreportMLBBSellAccountID = $_GET['reportMLBBSellAccountID'];
...
AND b.MLBB_SELLACCOUNTID = $getreportMLBBSellAccountID
";

$result = mysqli_query($conn,$sql);
$row = mysqli_fetch_assoc($result);

$mlbbsellAccountID = ['MLBB_SELLACCOUNTID'];
$userID1 = $row['Name'];

if(isset($_POST['report'])){
    $reportmlbbsellaccountCategory = mysqli_real_escape_string($conn,$_POST['reportmlbbsellaccountCategory']);
    $reportmlbbsellaccountDetails = mysqli_real_escape_string($conn,$_POST['reportmlbbsellaccountDetails']);
    $sql = "INSERT INTO `reportuser` (USER_ID,MLBB_SELLACCOUNTID,
    REPORT_CATEGORY,REPORT_DETAIL)
    VALUES((SELECT USER_ID FROM users WHERE USER_USERNAME='$useruserName'),
    (SELECT MLBB_SELLACCOUNTID FROM mlbbsellaccount WHERE MLBB_SELLACCOUNTID='$getreportMLBBSellAccountID'),
    '$reportmlbbsellaccountCategory','$reportmlbbsellaccountDetails')";
    $result=mysqli_query($conn,$sql);
    if($result){
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class = "form">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" aria-label="Default select example" name="reportmlbbsellaccountCategory">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" name="reportmlbbsellaccountDetails" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" autocomplete="off" required></textarea>
                        ...
                        <div class="inputfield">
                            <button type="button" class="btn btn-primary btn-lg btn-block" 
                                onclick="location.href = 'mlbbaccountforsale.php'">
                                Back
                            </button>
                        </div>
