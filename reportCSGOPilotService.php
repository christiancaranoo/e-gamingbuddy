...
$getreportCSGOPilotServiceID = $_GET['reportCSGOPilotServiceID'];
...
AND b.CSGO_PILOTSERVICEID = $getreportCSGOPilotServiceID 
";

$result = mysqli_query($conn,$sql);
$row = mysqli_fetch_assoc($result);

$csgopilotserviceID = ['CSGO_PILOTSERVICEID'];
$userID = $row['Name'];

if(isset($_POST['report'])){
    $reportcsgopilotserviceCategory = mysqli_real_escape_string($conn,$_POST['reportcsgopilotserviceCategory']);
    $reportcsgopilotserviceDetails = mysqli_real_escape_string($conn,$_POST['reportcsgopilotserviceDetails']);
    $sql = "INSERT INTO `reportuser` (USER_ID,CSGO_PILOTSERVICEID,
    REPORT_CATEGORY,REPORT_DETAIL)
    VALUES((SELECT USER_ID FROM users WHERE USER_USERNAME='$useruserName'),
    (SELECT CSGO_PILOTSERVICEID FROM csgopilotservice WHERE CSGO_PILOTSERVICEID='$getreportCSGOPilotServiceID'),
    '$reportcsgopilotserviceCategory','$reportcsgopilotserviceDetails')";
    $result=mysqli_query($conn,$sql);
    if($result){
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class = "form">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" aria-label="Default select example" name="reportcsgopilotserviceCategory">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" name="reportcsgopilotserviceDetails" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" autocomplete="off" required></textarea>
                        ...
                        <div class="inputfield">
                            <button type="button" class="btn btn-primary btn-lg btn-block" 
                                onclick="location.href = 'csgopilotservice.php'">
                                Back
                            </button>
                        </div>
