...
<html lang="en">
    ...
    <head>
        <meta charset="UTF-8">
        <title>Admin - Clash of Clan Report List</title>
            ...
            <div class="table-responsive-xxl">
                ...
                <nav aria-label="...">
                    <ul class="pagination pagination-lg">
                        ...
                        <li class="page-item active" aria-current="page"><a class="page-link" href="#"><img src = "image/clashofclan.jpg" width="35" height="35" alt = "Clash of Clan"> Clash of Clan</a></li>
