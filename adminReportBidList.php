            ...
            <div class="table-responsive-xxl">
                ...
                <nav aria-label="...">
                    <ul class="pagination pagination-lg">
                        ...
                        <li class="page-item active" aria-current="page"><a class="page-link" href="#"><img src = "image/auction.png" width="35" height="35" alt = "Valorant"> Bid</a></li>
                    </ul>
                </nav>
                <table class="table">
                    <thead>
                                ...
                                while($row=mysqli_fetch_assoc($result)){
                                    ...
                                    echo '
                                        <tr>
                                            ...
                                            <td>'.$userID.'</td>
                                            <td>
                                                <a href="viewComplaintFullDetailsBidItem.php? viewFullDetailsBidItemID='.$bidItemID.'" style="color:blue" target="_blank">
                                                    '.$bidItemID.'
                                                </a>
                                            </td>
