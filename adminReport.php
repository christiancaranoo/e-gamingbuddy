            ...
            <div class="table-responsive-xxl">
                ...
                <nav aria-label="...">
                    <ul class="pagination pagination-lg">
                        <li class="page-item active" aria-current="page"><a class="page-link" href="#"><img src = "image/visualization.png" width="35" height="35" alt = "Mobile Legends" > ALL</a></li>
                        ...
                        <li class="page-item"><a class="page-link" href="adminReportDota2List.php"><img src = "image/dota-2.png" height = "35" width = "35"> Dota 2</a></li>
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col-sm-3">Complaint ID</th>
                        ...
                        <?php
                            ...
                            if($result){
                                while($row=mysqli_fetch_assoc($result)){
                                    ...
                                    $csgoSellAccountID = $row['CSGO_SELLACCOUNTID'];
                                    $csgoPilotServiceID = $row['CSGO_PILOTSERVICEID'];
                                    $mobilelegendSellAccountID = $row['MLBB_SELLACCOUNTID'];
                                    $mobilelegendPilotServiceID = $row['ML_PILOTSERVICEID'];
                                    $clashofclanID = $row['CLASHOFCLAN_ID'];
                                    $valorantsellItemID = $row['VALORANT_SELLITEMID'];
                                    $valorantPilotServiceID = $row['VALORANT_PILOTSERVICEID'];
                                    $biditemID = $row['BID_ITEMID'];
                                    ...
                                    echo '
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="viewComplaintFullDetailsCSGOSellItem.php? viewFullDetailsCSGOSellItemID='.$csgoSellItemID.'" style="color:blue" target="_blank">
                                                    '.$csgoSellItemID.'
                                                </a>
                                                <a href="viewComplaintFullDetailsCSGOSellAccount.php? viewFullDetailsCSGOSellAccountID='.$csgoSellAccountID.'" style="color:blue" target="_blank">
                                                    '.$csgoSellAccountID.'
                                                </a>
                                                <a href="viewComplaintFullDetailsCSGOPilotService.php? viewFullDetailsCSGOPilotServiceID='.$csgoPilotServiceID.'" style="color:blue" target="_blank">
                                                    '.$csgoPilotServiceID.'
                                                </a>
                                                <a href="viewComplaintFullDetailsMLBBSellAccount.php? viewFullDetailsMLBBSellAccountID='.$mobilelegendSellAccountID.'" style="color:blue" target="_blank">
                                                    '.$mobilelegendSellAccountID.'
                                                </a>
                                                <a href="viewComplaintFullDetailsMLBBPilotService.php? viewFullDetailsMLBBPilotServiceID='.$mobilelegendPilotServiceID.'" style="color:blue" target="_blank">
                                                    '.$mobilelegendPilotServiceID.'
                                                </a>
                                                <a href="viewComplaintFullDetailsClashofClan.php? viewFullDetailsClashofClanID='.$clashofclanID.'" style="color:blue" target="_blank">
                                                    '.$clashofclanID.'
                                                </a>
                                                <a href="viewComplaintFullDetailsValorantSellItem.php? viewFullDetailsValorantSellItemID='.$valorantsellItemID.'" style="color:blue" target="_blank">
                                                    '.$valorantsellItemID.'
                                                </a>
                                                <a href="viewComplaintFullDetailsValorantPilotService.php? viewFullDetailsValorantPilotServiceID='.$valorantPilotServiceID.'" style="color:blue" target="_blank">
                                                    '.$valorantPilotServiceID.'
                                                </a>
                                                <a href="viewComplaintFullDetailsValorantPilotService.php? viewFullDetailsValorantPilotServiceID='.$valorantPilotServiceID.'" style="color:blue" target="_blank">
                                                    '.$biditemID.'
                                                </a>
