...
$getreportValorantPilotServiceID = $_GET['reportValorantPilotServiceID'];
...
AND b.VALORANT_PILOTSERVICEID = $getreportValorantPilotServiceID  
";

$result = mysqli_query($conn,$sql);
$row = mysqli_fetch_assoc($result);

$valorantpilotserviceID = ['VALORANT_PILOTSERVICEID'];
$userID = $row['Name'];

if(isset($_POST['report'])){
    $reportvalorantpilotserviceCategory = mysqli_real_escape_string($conn,$_POST['reportvalorantpilotserviceCategory']);
    $reportvalorantpilotserviceDetails = mysqli_real_escape_string($conn,$_POST['reportvalorantpilotserviceDetails']);
    $sql = "INSERT INTO `reportuser` (USER_ID,VALORANT_PILOTSERVICEID,
    REPORT_CATEGORY,REPORT_DETAIL)
    VALUES((SELECT USER_ID FROM users WHERE USER_USERNAME='$useruserName'),
    (SELECT VALORANT_PILOTSERVICEID FROM valorantpilotservice WHERE VALORANT_PILOTSERVICEID='$getreportValorantPilotServiceID'),
    '$reportvalorantpilotserviceCategory','$reportvalorantpilotserviceDetails')";
    $result=mysqli_query($conn,$sql);
    if($result){
                ...
                <form method="post" enctype="multipart/form-data">
                    <div class = "form">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-select" aria-label="Default select example" name="reportvalorantpilotserviceCategory">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" name="reportvalorantpilotserviceDetails" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" autocomplete="off" required></textarea>
                        ...
                        <div class="inputfield">
                            <button type="button" class="btn btn-primary btn-lg btn-block" 
                                onclick="location.href = 'valorantpilotservice.php'">
                                Back
                            </button>
                        </div>
